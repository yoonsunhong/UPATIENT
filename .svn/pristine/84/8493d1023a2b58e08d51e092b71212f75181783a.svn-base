			...
			<div class="tab clear" id="tab2">
				<div class="tab_btn_bg">
					<ul class="tab_btn area clear">
						<li><a href="#" onClick="bodyMassIndexTimeView()"><spring:message code="timeLine"/><!-- 타임라인 --></a></li>
						<li class="on"><a href="#" onClick="bodyMassIndexTrandView()"><spring:message code="trends"/><!-- 트랜드 --></a></li>
					</ul>
				</div>
				<div class="tab clear" id="tab3">	
					...
					<div class="tab_cnt">
						<div class="cnt1">
							<h2 class="tit">체중 그래프</h2>
							<div id="chart1"><!-- 체중 그래프 영역 --></div>
							<h2 class="tit">체지방율 그래프</h2>
							<div id="chart2"><!--  그래프 영역 --></div>
							<h2 class="tit">BMI 그래프</h2>
							<div id="chart3"><!-- BMI 그래프 영역 --></div>
							<h2 class="tit">근육량 그래프</h2>
							<div id="chart4"><!-- 근육량 영역 --></div>							
							<h2 class="tit">골량 그래프</h2>
							<div id="chart5"><!-- 골량 그래프 영역 --></div>
							<h2 class="tit">수분량 그래프</h2>
							<div id="chart6"><!-- 수분량 그래프 영역 --></div>
							<h2 class="tit">내장지방지수 그래프</h2>
							<div id="chart7"><!-- 내장지방지수 영역 --></div>										
						</div>
					</div>
				</div>
			</div>
