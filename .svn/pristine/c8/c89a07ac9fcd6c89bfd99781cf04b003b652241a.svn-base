			...
			<div class="tab clear" id="tab2">
				<div class="tab_btn_bg">
					<ul class="tab_btn area clear">
						<li><a href="#" onClick="bloodPressureTimeView()"><spring:message code="timeLine"/><!-- 타임라인 --></a></li>
						<li class="on"><a href="#" onClick="bloodPressureTrandView()"><spring:message code="trends"/><!-- 트랜드 --></a></li>
					</ul>
				</div>
