...
<body>
	<!--==================== 전체 영역 시작 ====================-->
	<div id="wrap" class="goal_set_bmi">
		<!--==================== 헤더 영역 시작 ====================-->
		<header id="header">
			<div class="area">
				<div>
			...
			<div class="tab clear" id="tab2">	
				<div class="tab_btn_bg">
					<div class="tab_btn area clear">
						<ul>
							...
							<li><a href="#" onClick="goalSettingBloodPressure()">혈압</a></li>
							<li class="on"><a href="#" onClick="goalSettingBodyMassIndex()">BMI</a></li>
						</ul>
					</div>
				</div>
				<div class="tab_cnt area">
					...
					<div class="goal_img">
						...
						<div>
							<img src="/resources/images/bg/goal_BMI.png" alt="BMI 목표 설정 참고용 이미지">
						</div>
					</div>
				</div>
			</div>
