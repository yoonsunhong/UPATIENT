...
@Repository("bodyMassIndexMstDao")
public class BodyMassIndexMstDao extends EgovAbstractDAO {

	public int insertBmiMeasureInfo(Map<String, Object> param) {
		return update("bodyMassIndexMst.insertBmiMeasureInfo", param);
	}

	public int updateBmiMeasureInfo(Map<String, Object> param) {
		return update("bodyMassIndexMst.updateBmiMeasureInfo", param);
	}
