...
@Repository("BloodPressureTrandViewDao")
public class BloodPressureTrandViewDao extends EgovAbstractDAO {

	public List<BloodPressureTrandViewVO> selectBpMeasureTrandView10(HashMap<String, Object> map) {
		return  (List<BloodPressureTrandViewVO>) list("bloodPressureTrandView.selectBpMeasureTrandView10", map);
	}
	
	public List<BloodPressureTrandViewVO> selectBpMeasureTrandView(HashMap<String, Object> map) {
		return  (List<BloodPressureTrandViewVO>) list("bloodPressureTrandView.selectBpMeasureTrandView", map);
	}
