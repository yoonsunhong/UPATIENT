...
@Repository("BloodGlucoseMstDao")
public class BloodGlucoseMstDao extends EgovAbstractDAO {

	@SuppressWarnings("unchecked")
	public List<BloodGlucoseMstVO> selectMeasurePointList(String lang){
		return (List<BloodGlucoseMstVO>) list("bloodGlucoseMst.selectMeasurePointList", lang);
	}
	
	public int insertBsMeasureInfo(Map<String, Object> param) {
		return update("bloodGlucoseMst.insertBsMeasureInfo", param);
	}

	public int updateBsMeasureInfo(Map<String, Object> param) {
		return update("bloodGlucoseMst.updateBsMeasureInfo", param);
	}
