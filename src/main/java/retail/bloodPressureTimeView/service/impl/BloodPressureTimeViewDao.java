...
@Repository("BloodPressureTimeViewDao")
public class BloodPressureTimeViewDao extends EgovAbstractDAO {
	
	@SuppressWarnings("unchecked")
	public List<BloodPressureTimeViewVO> selectBpTimeLinelList(HashMap<String, String> map){
		return (List<BloodPressureTimeViewVO>) list("bloodPressureTimeView.selectBpTimeLinelList", map);
	}
}
