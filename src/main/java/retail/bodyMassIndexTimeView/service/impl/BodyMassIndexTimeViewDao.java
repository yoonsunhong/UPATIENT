...
@Repository("BodyMassIndexTimeViewDao")
public class BodyMassIndexTimeViewDao extends EgovAbstractDAO {
	
	@SuppressWarnings("unchecked")
	public List<BodyMassIndexTimeViewVO> selectBmiTimeLinelList(HashMap<String, String> map){
		return (List<BodyMassIndexTimeViewVO>) list("bodyMassIndexTimeView.selectBmiTimeLinelList", map);
	}
}
