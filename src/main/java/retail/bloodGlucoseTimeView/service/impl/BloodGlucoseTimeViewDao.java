...
@Repository("BloodGlucoseTimeViewDao")
public class BloodGlucoseTimeViewDao extends EgovAbstractDAO {
	
	@SuppressWarnings("unchecked")
	public List<BloodGlucoseTimeViewVO> selectBsTimeLinelList(HashMap<String, String> map){
		return (List<BloodGlucoseTimeViewVO>) list("bloodGlucoseTimeView.selectBsTimeLinelList", map);
	}
}
